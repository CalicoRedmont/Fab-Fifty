(function () {
  ...
  const PLAYERS = [
    ...
    { id: "manu", name: "Manu", initials: "MA", files: ["Manu.jpg", "Manu-px.png", "Manu.png"], difficulty: "normal", line: "Énergie cinétique et issue variable." },
  ...
  const PLAYER_FLAVOR_PROFILES = {
    ...
    manu: { shortProfile: "réflexe tardif", profile: "réflexe tardif mais sincère", quote: "Énergie cinétique et issue variable." },
