(function () {
  ...
  const PLAYERS = [
    ...
    { id: "stephane", name: "Stéphane", initials: "ST", files: ["Stephane.jpg", "Stephane-px.png", "Stephane.png", "Stéphane-px.png"], difficulty: "hard", line: "Coup droit électrique avec distorsion" },
  ...
  const PLAYER_FLAVOR_PROFILES = {
    ...
    stephane: { shortProfile: "angle discutable", profile: "angle discutable", quote: "Coup droit électrique avec distorsion" },
