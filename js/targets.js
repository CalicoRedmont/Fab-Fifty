(function () {
  ...
  const PLAYERS = [
    ...
    { id: "stephane", name: "Stéphane", initials: "ST", files: ["Stephane.jpg", "Stephane-px.png", "Stephane.png", "Stéphane-px.png"], difficulty: "hard", line: "Smash en mode disto à 200 dB." },
    ...
    { id: "olivierr", name: "Olivier R.", initials: "OR", files: ["Olivier.R.jpg", "Olivier-H-px.png", "Olivier.png"], difficulty: "normal", line: "Un service qui dessert." },
  ...
  const PLAYER_FLAVOR_PROFILES = {
    ...
    stephane: { shortProfile: "angle discutable", profile: "angle discutable", quote: "Smash en mode disto à 200 dB." },
    ...
    olivierr: { shortProfile: "revers administratif", profile: "revers administratif", quote: "Un service qui dessert." },
